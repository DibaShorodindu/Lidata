        ...
        <div class="container">
          ...
          <div class="row py-5 px-3">
            <div class="col-md-6 pe-4">
              ...
              <div>
              <a href="{{ route('category', ['id' => 'A'])  }}" class="blue-link  @if ($dataId == 'A') active  @endif" >A</a>
                <a href="{{ route('category', ['id' => 'B'])  }}" class="blue-link @if ($dataId == 'B') active  @endif" >B</a>
                <a href="{{ route('category', ['id' => 'C'])  }}" class="blue-link @if ($dataId == 'C') active  @endif" >C</a>
                <a href="{{ route('category', ['id' => 'D'])  }}" class="blue-link @if ($dataId == 'D') active  @endif" >D</a>
                <a href="{{ route('category', ['id' => 'E'])  }}" class="blue-link @if ($dataId == 'E') active  @endif" >E</a>
                <a href="{{ route('category', ['id' => 'F'])  }}" class="blue-link @if ($dataId == 'F') active  @endif" >F</a>
                <a href="{{ route('category', ['id' => 'G'])  }}" class="blue-link @if ($dataId == 'G') active  @endif" >G</a>
                <a href="{{ route('category', ['id' => 'H'])  }}" class="blue-link @if ($dataId == 'H') active  @endif" >H</a>
                <a href="{{ route('category', ['id' => 'I'])  }}" class="blue-link @if ($dataId == 'I') active  @endif" >I</a>
                <a href="{{ route('category', ['id' => 'J'])  }}" class="blue-link @if ($dataId == 'J') active  @endif" >J</a>
                <a href="{{ route('category', ['id' => 'K'])  }}" class="blue-link @if ($dataId == 'K') active  @endif" >K</a>
                <a href="{{ route('category', ['id' => 'L'])  }}" class="blue-link @if ($dataId == 'L') active  @endif" >L</a>
                <a href="{{ route('category', ['id' => 'M'])  }}" class="blue-link @if ($dataId == 'M') active  @endif" >M</a>
                <a href="{{ route('category', ['id' => 'N'])  }}" class="blue-link @if ($dataId == 'N') active  @endif" >N</a>
                <a href="{{ route('category', ['id' => 'O'])  }}" class="blue-link @if ($dataId == 'O') active  @endif" >O</a>
                <a href="{{ route('category', ['id' => 'P'])  }}" class="blue-link @if ($dataId == 'P') active  @endif" >P</a>
                <a href="{{ route('category', ['id' => 'Q'])  }}" class="blue-link @if ($dataId == 'Q') active  @endif" >Q</a>
                <a href="{{ route('category', ['id' => 'R'])  }}" class="blue-link @if ($dataId == 'R') active  @endif" >R</a>
                <a href="{{ route('category', ['id' => 'S'])  }}" class="blue-link @if ($dataId == 'S') active  @endif" >S</a>
                <a href="{{ route('category', ['id' => 'T'])  }}" class="blue-link @if ($dataId == 'T') active  @endif" >T</a>
                <a href="{{ route('category', ['id' => 'U'])  }}" class="blue-link @if ($dataId == 'U') active  @endif" >U</a>
                <a href="{{ route('category', ['id' => 'V'])  }}" class="blue-link @if ($dataId == 'V') active  @endif" >V</a>
                <a href="{{ route('category', ['id' => 'W'])  }}" class="blue-link @if ($dataId == 'W') active  @endif" >W</a>
                <a href="{{ route('category', ['id' => 'X'])  }}" class="blue-link @if ($dataId == 'X') active  @endif" >X</a>
                <a href="{{ route('category', ['id' => 'Y'])  }}" class="blue-link @if ($dataId == 'Y') active  @endif" >Y</a>
                <a href="{{ route('category', ['id' => 'Z'])  }}" class="blue-link @if ($dataId == 'Z') active  @endif" >Z</a>
              </div>
            </div>
