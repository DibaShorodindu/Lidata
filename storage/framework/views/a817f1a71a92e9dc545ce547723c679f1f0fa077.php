...
<html lang="en">
  <head>
    ...
    <title><?php echo e($data->person_name); ?>s Contact Details | Li Data</title>
        ...
        <div class="row" id="home-navbar">
          ...
          <nav class="navbar navbar--center d-lg-flex d-none">
            <ul class="navbar__ul">
              ...
              <li class="navbar__li">
                <a href="<?php echo e(route('pricing-us')); ?>" class="navbar__a">
                  Pricing
                </a>
              </li>
              <li class="navbar__li">
      ...
      <div class="navigation">
        ...
        <nav class="navigation__nav">
          <ul class="navigation__list">
            ...
            <li class="navigation__item">
              <a href="<?php echo e(route('pricing-us')); ?>" class="navigation__link">Pricing</a>
            </li>
            <li class="navigation__item">
          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-6 ms-md-auto">
              ...
              <form action="<?php echo e(route('userSearch')); ?>">
                <?php echo csrf_field(); ?>
                <div class="col-12">
                  <input  type="text" name="searchPeople" id="searchPeople"   class="searchBar bg-white border-5 text-dark fw-normal col-md-11 col-11"  placeholder="Search by Name..." onkeyup="searchPeople()" autocomplete="off"  />
                </div>
                </form>
              </div>
            </div>
            <div class="col-md-3 col-6">
              ...
              <form action="<?php echo e(route('Company_Search')); ?>">
                <?php echo csrf_field(); ?>
                <div class="col-12">
                  <input  type="text" name="searchCompany" id="searchCompany"  class="searchBar bg-white border-5 text-dark fw-normal col-md-11 col-11"  placeholder="Search by Company..." onkeyup="searchCompany()" autocomplete="off"  />
                </div>
                </form>
              </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/front/user/user.blade.php ENDPATH**/ ?>