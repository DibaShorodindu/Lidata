      ...
      <div class="container">
        <div class="row my-3">
          ...
          <div class="col-md-6 d-lg-flex banner-bg d-none">
            <img class="img-fluid banner-bg--img" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/banner.svg" alt="banner" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          <div class="col-md-8 pe-5 d-flex flex-column justify-content-center" data-aos="fade-left"
            ...
            <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('user.login')); ?>"class="btn-txt mt-3">
                            Get Started →
                        </a>
                    <?php else: ?>
    ...
    <section class="section-service03 u-padding-lg">
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          ...
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
            <img class="img-fluid" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/service03.svg" alt="service illustration" />
          </div>
        </div>
      </div>
    </section>
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lidata\resources\views/index.blade.php ENDPATH**/ ?>