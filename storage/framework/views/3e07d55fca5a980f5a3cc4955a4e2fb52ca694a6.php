        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 px-5">
                    ...
                    <a href="<?php echo e(route('/phonelistUserRegister')); ?>" class="btn btn-grad">Try It Now</a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 px-5">
                    ...
                    <a href="<?php echo e(route('/phonelistUserRegister')); ?>" class="btn-txt mt-3"> Try It Now → </a>
                </div>
                <div class="offset-md-1 col-md-6 mt-md-0 mt-5 pt-md-0 pt-5">
                    <img
                        class="img-fluid"
                        src="<?php echo e(asset('/')); ?>adminAsset/assets/images/feature01.svg"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img
                        class="img-fluid"
                        src="<?php echo e(asset('/')); ?>adminAsset/assets/images/feature02.svg"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-md-1 col-md-6 mt-md-0 mt-5 pt-md-0 pt-5">
                    <img
                        class="img-fluid"
                        src="<?php echo e(asset('/')); ?>adminAsset/assets/images/feature03.svg"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img
                        class="img-fluid"
                        src="<?php echo e(asset('/')); ?>adminAsset/assets/images/feature04.svg"
                        alt="Feature02 Illustration"
                    />
                </div>
                <div class="offset-md-1 col-md-5 px-5 mt-md-0 mt-5 pt-md-0 pt-5">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-10 col-md-6 col-8 mx-auto mx-lg-0">
                            ...
                            <div class="facebook-signup mx-lg-0 mx-auto mt-4">
                                ...
                                >
                                    <img
                                        src="<?php echo e(asset('/')); ?>adminAsset/assets/images/icons/facebook.svg"
                                        alt="facebook logo"
                                        class="me-2 img-fluid"
                                    />
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/product/product.blade.php ENDPATH**/ ?>