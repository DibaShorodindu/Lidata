    ...
    <div class="container">
      <div class="row pt-3">
        <div class="col-lg-3 pl-5 mb-lg-0 mb-5">
          <a href="/">
            <img class="img-fluid footer__logo" src="assets/images/logo--company-name-dark.svg" alt="phone list" />
          </a>
        </div>
  ...
  <!-- END FOOTER --><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/front/includes/footer.blade.php ENDPATH**/ ?>