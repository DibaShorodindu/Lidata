...
<div class="container">
    <div class="row" id="home-navbar">
        <div class="navbar__logo">
            <a class="navbar-brand d-lg-flex" href="<?php echo e(route('/')); ?>">
                <img class="img-fluid" src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/logo--company-name-dark.svg" alt="phone list" />
            </a>
        </div>
        ...
        <nav class="navbar navbar--center d-lg-flex d-none">
            <ul class="navbar__ul">
                ...
                <li class="navbar__li">
                    <a href="<?php echo e(route('packages')); ?>" class="navbar__a"> Pricing </a>
                </li>
                <li class="navbar__li">
                    <a href="https://blog.phonelist.io" class="navbar__a"> Blog </a>
                </li>
                <li class="navbar__li">
                    <a href="<?php echo e(route('careers')); ?>" class="navbar__a"> Careers </a>
                </li>
            </ul>
        </nav>
...
<!-- END NAVBAR -->
<?php /**PATH D:\xampp\htdocs\PhoneList\resources\views/front/includes/header.blade.php ENDPATH**/ ?>