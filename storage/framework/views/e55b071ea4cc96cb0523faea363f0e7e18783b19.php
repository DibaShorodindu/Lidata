  ...
  <section class="section-dashboard">
    ...
    <section class="section-dashboard--main section-viewalldata">
        ...
        <div class="row pt-2 pb-4">
          ...
          <?php endif; ?>
            <table class="table table-hover table-bordered table-responsive" id="table">
              ...
              <tbody>
              <?php $__currentLoopData = $company_employes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="table-row">
                <td><?php echo e($datain->id); ?></td>
                  <td scope="row" class="name">
                    <a href="companyDetails.html"><?php echo e($datain->organization_name); ?></a>
                  </td>
                  <td><?php echo e($datain->organization_website_url); ?></td>
                  <td><?php echo e($datain->organization_phone); ?></td>
                  <td>
                  <?php echo e($datain->organization_num_current_employees); ?>
                  ...
                  <td>
                    <a type="button" class="btn btn-delete bg-danger ms-4" href="/delete_lidata/<?php echo e($datain->id); ?>">Delete</a>
                  </td>
                </tr>
      ...
      <div class="d-flex justify-content-end">
        <?php echo $company_employes->links(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/viewCompanyData.blade.php ENDPATH**/ ?>