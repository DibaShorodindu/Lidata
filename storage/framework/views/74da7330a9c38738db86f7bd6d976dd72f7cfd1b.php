          ...
          >
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item pl-4">
                <a class="nav-link active" aria-current="page" href="<?php echo e(route('loggedInUser')); ?>">
                  <i class="bi bi-house-door"></i>
                  Dashboard
                </a>
              </li>
              <li class="nav-item d-none d-md-block" id="search">
                <a class="nav-link nav-link__search" href="<?php echo e(route('people')); ?>">
...
<?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/userDashboard/includes/header.blade.php ENDPATH**/ ?>