      ...
      <div class="row" id="home-navbar">
        <div class="navbar__logo">
          <a class="navbar-brand d-lg-flex" href="<?php echo e(url('/')); ?>">
            <img class="img-fluid" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/logo--company-name-dark.svg" alt="li data" />
          </a>
        </div>
        ...
        <nav class="navbar navbar--right d-lg-flex d-none">
          <ul class="navbar__ul align-items-center">
            ...
            <?php if(auth()->guard()->guest()): ?>
                    <li class="navbar__li">
                        <a href="<?php echo e(route('user.login')); ?>" class="navbar__a"> Account </a>
                    </li>
                <?php else: ?>
                    <li class="navbar__li">
    ...
    <!-- END NAVBAR -->
<?php /**PATH E:\xampp\htdocs\Lidata\resources\views/front/includes/header.blade.php ENDPATH**/ ?>