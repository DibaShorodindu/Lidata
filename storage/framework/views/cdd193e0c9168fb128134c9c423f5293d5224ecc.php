    ...
    <section class="section-main">
        ...
        <section class="second-navbar">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a href="<?php echo e(route('exports')); ?>" class="nav-link">CSV Exports</a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('csv-export-settings')); ?>" class="nav-link active"
...
<?php echo $__env->make('userDashboard.settings.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/userDashboard/settings/exports/csv-export-settings.blade.php ENDPATH**/ ?>