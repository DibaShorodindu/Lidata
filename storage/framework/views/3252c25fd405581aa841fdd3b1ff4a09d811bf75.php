        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 px-5">
              ...
              <a href="signup.html" class="btn btn-grad">Try It Now</a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 px-5">
              ...
              <a href="signup.html" class="btn-txt mt-3"> Try It Now → </a>
            </div>
            <div class="offset-md-1 col-md-6 mt-md-0 mt-5 pt-md-0 pt-5">
              <img
                class="img-fluid"
                src="assets/images/feature01.svg"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <img
                class="img-fluid"
                src="assets/images/feature02.svg"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="offset-md-1 col-md-6 mt-md-0 mt-5 pt-md-0 pt-5">
              <img
                class="img-fluid"
                src="assets/images/feature03.svg"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <img
                class="img-fluid"
                src="assets/images/feature04.svg"
                alt="Feature02 Illustration"
              />
            </div>
            <div class="offset-md-1 col-md-5 px-5 mt-md-0 mt-5 pt-md-0 pt-5">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/product.blade.php ENDPATH**/ ?>