                    ...
                    <div class="col-md-8 p-0">
                        ...
                        <div class="card p-4 border-0 rounded-3">
                            <div class="card-title m-0 d-flex justify-content-between align-items-center  col-12">
                                ...
                                <div class="col-7">
                                    ...
                                    <?php endif; ?>
                                    <?php if( !$userCardInfo->isEmpty() ): ?>
                                        <a href="<?php echo e(route('removeCard')); ?>">
                        ...
                        <!-- Modal -->
                            ...
                            <div class="credit-card-info u-box-shadow-2 mt-4">
                                <form action="<?php echo e(route('upgrade')); ?>" enctype="multipart/form-data" method="get">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('userDashboard.settings.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Lidata\resources\views/userDashboard/settings/plans/billing.blade.php ENDPATH**/ ?>