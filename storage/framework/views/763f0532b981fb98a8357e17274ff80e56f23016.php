        ...
        <div class="login-form">
            <div class="card border-0 u-box-shadow-1 rounded-3">
                <div class="col-12 company-logo">
                    <img src="<?php echo e(asset('/')); ?>assets/images/logo--company-name-dark.svg" alt="logo" />
                </div>
                <div class="card-title d-flex">
                    <a href="<?php echo e(route('/phonelistUserLogin')); ?>" class="login p-4">Log in</a>
                    <a href="<?php echo e(route('/phonelistUserRegister')); ?>" class="signup p-4"
                ...
                <div class="card-body p-5 pb-3">
                    ...
                    <form action="<?php echo e(route('/phonelistUserLoginAuth')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-5">
...
<?php echo $__env->make('user.userMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/user/userLogin.blade.php ENDPATH**/ ?>