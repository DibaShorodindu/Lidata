      ...
      <div class="container">
        ...
        <div class="row my-5 py-5">
          <div class="col-md-4 col-8 mx-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/user01.jpg" alt="founder">
              <div class="card-body">
          ...
          <div class="col-md-4 col-8 mx-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/user02.jpg" alt="">
              <div class="card-body">
          ...
          <div class="col-md-4 col-8 mx-auto">
            <div class="card">
              <img class="card-img-top img-fluid" src="<?php echo e(asset('/')); ?>adminAsset/assets/images/user03.jpg" alt="">
              <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lidata\resources\views/front/career/careers.blade.php ENDPATH**/ ?>