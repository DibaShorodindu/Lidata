    ...
    <section class="section-dashboard--main">
      <div class="container">
        <div class="row">
          ...
          <form action="<?php echo e(route('employee.import')); ?>" class="d-flex"  method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/admin.blade.php ENDPATH**/ ?>