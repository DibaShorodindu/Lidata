...
<?php $__env->startSection('main'); ?>
      ...
      <div class="container">
        <div class="row my-3">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <div class="google-signup mx-lg-0 mx-auto">
                                    <a type="button" class="btn btn-google-login u-box-shadow-2" href="<?php echo e(route('/auth/google')); ?>">
                                        <img src="<?php echo e(asset('/')); ?>/assets/images/icons/google.svg" alt="google logo" class="me-2" />
                                        Sign up with google
                                    </a>
                                </div>
                                <div class="facebook-signup mx-lg-0 mx-auto mt-4">
                                    <a type="button" class="btn btn-facebook-login u-box-shadow-2" href="<?php echo e(url('auth/facebook')); ?>">
                                        <img src="<?php echo e(asset('/')); ?>/assets/images/icons/facebook.svg" alt="facebook logo" class="me-2" />
          ...
          <div class="col-md-6 d-lg-flex banner-bg d-none">
            <img class="img-fluid banner-bg--img" src="assets/images/banner.svg" alt="banner" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          <div class="col-md-8 pe-5 d-flex flex-column justify-content-center" data-aos="fade-left"
            ...
            <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('/phonelistUserRegister')); ?>"class="btn-txt mt-3">
                            Get Started →
                        </a>
                    <?php else: ?>
          ...
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
            <img src="assets/images/service01.svg" class="img-fluid" alt="service illustration" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
            <img src="assets/images/service02.svg" class="img-fluid" alt="service illustration" />
          </div>
    ...
    <section class="section-service03 u-padding-lg">
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          ...
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
            <img class="img-fluid" src="assets/images/service03.svg" alt="service illustration" />
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              <div class="card border-0 bg-transparent">
                <div class="card-body">
                  <h4 class="card-title">
                    <span class="counter" data-count="<?php echo e($rowcount3); ?>"> 0 </span>
                  </h4>
    ...
    <section class="section-service04 u-padding-lg">
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
            <img src="assets/images/service04.svg" class="img-fluid" alt="service illustration" />
          </div>
          <div class="col-md-8 pe-5 d-flex flex-column justify-content-center" data-aos="fade-right"
    ...
    <section class="section-service05 bg-light u-padding-lg">
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          ...
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
            <img src="assets/images/service05.png" class="img-fluid" alt="service illustration" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section-service06 u-padding-lg">
      <div class="container">
        <div class="row" style="overflow-x: hidden">
          <div class="col-md-4 p-5 mt-5 mt-md-0" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
            <img src="assets/images/service06.png" class="img-fluid" alt="service illustration" />
          </div>
          <div class="col-md-8 pe-5 d-flex flex-column justify-content-center" data-aos="fade-right"
            data-aos-duration="1000">
            <h3 class="section-title mb-5">
            ...
            <div class="swiper">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card">
                    <img class="card-img-top img-fluid rounded-circle" src="assets/images/user01.jpg"
                      alt="User01 Image" />
                ...
                <div class="swiper-slide">
                  <div class="card">
                    <img class="card-img-top img-fluid rounded-circle" src="assets/images/user02.jpg"
                      alt="User02 Image" />
                ...
                <div class="swiper-slide">
                  <div class="card">
                    <img class="card-img-top img-fluid rounded-circle" src="assets/images/user03.jpg"
                      alt="User03 Image" />
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/index.blade.php ENDPATH**/ ?>