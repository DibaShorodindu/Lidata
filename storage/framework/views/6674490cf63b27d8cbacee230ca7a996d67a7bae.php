        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 px-5">
              ...
              <a href="<?php echo e(route('user.register')); ?>" class="btn btn-grad">Try It Now</a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 px-5">
              ...
              <a href="<?php echo e(route('user.register')); ?>" class="btn-txt mt-3"> Try It Now → </a>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lidata\resources\views/front/product/product.blade.php ENDPATH**/ ?>