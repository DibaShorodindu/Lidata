...
<section class="section-main">
    ...
    <section class="second-navbar">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <form action="<?php echo e(route('managePlan')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input hidden type="text" name="userId" value="<?php echo e(Auth::user()->id); ?>">
                    <button type="submit" class="nav-link"> Plan Overview </button>
                </form>
            </li>
            <li class="nav-item">
                <form action="<?php echo e(route('billing')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input hidden type="text" name="userId" value="<?php echo e(Auth::user()->id); ?>">
...
<?php echo $__env->make('userDashboard.settings.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lidata\resources\views/userDashboard/settings/plans/billing.blade.php ENDPATH**/ ?>