...
<section class="section-user-dashboard">
        ...
        <section class="section-user-dashboard--sidebar">
          ...
          <form id="search" action="<?php echo e(route('companySearch')); ?>">
            <input
              type="text"
     ...
     <div class="input-company u-border-bottom py-4 px-4">
           ...
           <div class="input-city u-border-bottom py-4 px-4">
            ...
            <form id="searchLocation" action="<?php echo e(route('citySearch')); ?>">
            <input
            type="text"
            name="gender"
            id="gender"
            ...
            <form id="searchHometown" action="<?php echo e(route('stateSearch')); ?>">
            <input
              type="text"
              name="hometown"
              id="hometown"
          ...
          <div class="input-country u-border-bottom py-4 px-4">
            ...
            <form id="searchCountry" action="<?php echo e(route('country_companySearch')); ?>">
            <input
            type="text"
            name="country"
            id="country"
         ...
         <div class="input-industry py-4 px-4">
            ...
            <form id="searchCountry" action="<?php echo e(route('industry_companySearch')); ?>">
            <input
            type="text"
            name="industry"
            id="industry"
        ...
        <section class="section-user-dashboard--main">
          <div class="container">
            ...
            <div class="col-md-5 d-flex align-items-end ps-5">
              ...
              <form action="<?php echo e(route('cumpanyExport')); ?>" enctype="multipart/form-data" method="get">
                             <?php echo csrf_field(); ?>
              ...
              <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td>
                 <input type="checkbox" name="chk[]" id="chk" class="form-check-input" value="<?php echo e($data->id); ?>" >
                  ...
                  <!-- <td><?php echo e($data->organization_hq_location_state); ?>,<?php echo e($data->organization_hq_location_state); ?>,<?php echo e($data->organization_hq_location_country); ?>  </td> -->
                </tr>
...
<?php echo $__env->make('userDashboard.master_company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/userDashboard/companySearch.blade.php ENDPATH**/ ?>