                    ...
                    <form action="<?php echo e(route('/phonelistUserRegisterAdd')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input hidden
                                ...
                                value="<?php echo e($newUserData->name); ?>"
                                name="firstName"
                            />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="card-footer">
                            <p>
                                ...
                                <a href="login.<?php echo e(route('/phonelistUserLogin')); ?>">Sign In</a>
                            </p>
                        </div>
                    </form>
                </div>
...
<?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/user/userGoogleRegister.blade.php ENDPATH**/ ?>