    ...
    <div class="container">
      <div class="row pt-3">
        ...
        <div class="col-lg-3 pl-5 mb-lg-0 mb-5">
          <a href="/">
            <img class="img-fluid footer__logo" src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/logo--company-name-dark.svg" alt="phone list" />
          </a>
        </div>
          ...
          <div class="row pe-5">
            <div class="col-lg-4 col-md-5 col-4 mt-3">
              <a href="https://www.latestdatabase.com/">
                <img src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/latest-database--logo.svg" class="img-fluid partner-logo"
                  alt="latest database logo" />
              </a>
            </div>
            <div class="col-lg-4 col-md-5 col-4 mt-3 me-1">
              <a href="https://www.bcellphonelist.com/">
                <img src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/Brother Phone Number List--logo.svg" class="img-fluid partner-logo"
                  alt="Brother Phone Number List logo" />
              </a>
            </div>
            <div class="col-lg-4 col-md-5 col-4 mt-3">
              <a href="http://www.photoeditorph.com/">
                <img src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/phollipines-photo-editor--logo.svg" class="img-fluid partner-logo"
                  alt="Philippines Photo Editor logo" />
              </a>
            </div>
            <div class="col-lg-4 col-md-5 col-4 mt-3 me-1">
              <a href="https://www.mplists.com/">
                <img src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/mplists--logo.svg" class="img-fluid partner-logo" alt="Mp List logo" />
              </a>
            </div>
            <div class="col-lg-4 col-md-5 col-4 me-md-auto mt-3">
              <a href="http://www.seoexpartebd.com/">
                <img src="<?php echo e(asset('/')); ?>/adminAsset/assets/images/seo-exparte-logo.svg" class="img-fluid partner-logo"
      ...
      <div class="row bottom-line">
        ...
        <div class="col-md-8 mt-md-0 mt-4">
          <ul class="text-center m-auto terms">
            <li><a href="<?php echo e(route('termsAndServices')); ?>">Terms of service</a></li>
  ...
  <!-- END FOOTER -->
<?php /**PATH D:\xampp\htdocs\PhoneList\resources\views/front/includes/footer.blade.php ENDPATH**/ ?>