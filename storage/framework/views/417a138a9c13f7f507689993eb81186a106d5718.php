                ...
                <div class="card-body p-5 pb-3">
                    ...
                    <div class="card-title">
                        ...
                        <div>
                            ...
                            >
                                <img
                                    src="<?php echo e(asset('/')); ?>assets/images/icons/google.svg"
                                    alt="google logo"
                                    class="me-2"
                                />
                                Sign up with google
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('/phonelistUserRegisterAdd')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                        ...
                        <div class="card-footer">
                            <p>
                                ...
                                <a href="<?php echo e(route('/phonelistUserLogin')); ?>">Sign In</a>
                            </p>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('user.userMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/user/userRegister.blade.php ENDPATH**/ ?>