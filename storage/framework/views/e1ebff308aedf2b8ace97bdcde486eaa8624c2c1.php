...
<html lang="en">
    ...
    <body>
                    ...
                    <section class="section-user-dashboard--main">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- START TABLE -->
                                <div
                                class="section-table table-scrollable mx-5 mb-5"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($data->organization_hq_location_city)): ?>
                                                <?php echo e(ucwords($data->organization_hq_location_city) .', '.ucwords($data->organization_hq_location_state).','.ucwords($data->organization_hq_location_country)); ?>
     ...
     <?php /**PATH D:\xampp\htdocs\Lidata\resources\views/userDashboard/company.blade.php ENDPATH**/ ?>