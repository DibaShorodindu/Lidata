            ...
            <div class="card border-0 u-box-shadow-1 rounded-3">
                <div class="card-body p-5 pb-3">
                    ...
                    <form action="<?php echo e(route('add.new.user')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php if(isset($newUserData->email) != null): ?>
                            <div class="mb-4">
                                <input
                                        type="email"
                                        hidden
...
<?php echo $__env->make('user.userMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Lidata\resources\views/user/userFacebookRegister.blade.php ENDPATH**/ ?>