    ...
    <section class="section-dashboard--sidebar">
      ...
      <nav class="menubar">
        <ul class="menu d-flex flex-column">
          ...
          <li class="menu-item">
            <a href="<?php echo e(url('/lidata_company')); ?>">
              ...
              <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><?php echo e($data->id); ?></td>
                  <td scope="row" class="name">
                    <a href="user01.html"> <?php echo e($data->person_name); ?></a>
                  </td>
                  <td><?php echo e($data->person_title); ?></td>
                  <td><?php echo e($data->organization_name); ?></td>
                  <td>
                  <?php echo e($data->person_email); ?>

                  </td>
                  <td><?php echo e($data->person_sanitized_phone); ?></td>
                  <td>
                    <button type="button" class="btn btn-edit bg-primary" data-bs-toggle="modal"
                      data-bs-target="#editModal">Edit</button>
                  </td>
                  <td>
                    <a type="button" class="btn btn-delete bg-danger" href="/delete_post/<?php echo e($data->id); ?>">Delete</a>
                  </td>
...
<?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/viewPeopleData.blade.php ENDPATH**/ ?>