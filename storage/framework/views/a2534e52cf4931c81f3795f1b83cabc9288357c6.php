        ...
        <div class="container">
          <div class="row">
            <div class="offset-6 col-lg-3 col-md-4 col-6 ms-md-auto">
              <div class="row">
              <form action="<?php echo e(route('userSearch')); ?>" id="searchPeople">
                <?php echo csrf_field(); ?>
                <div class="col-12">
                  <input
                    type="text"
            ...
            <div class="col-lg-3 col-md-4 col-6">
              <div class="row">
              <form action="<?php echo e(route('Company_Search')); ?>" id="searchCompany" >
                <?php echo csrf_field(); ?>
                <div class="col-12">
                  <input
                    type="text"
...
<?php /**PATH C:\xampp\htdocs\lidata_list\resources\views/front/directory/company/company.blade.php ENDPATH**/ ?>